...
import { api, getHighQualityImage, formatDuration, normalizeSong, getHighQualityDownloadUrl, BASE_URL, DEFAULT_STALE_TIME } from '@/lib/api';
import { Play, Pause, Heart, Clock, Download, Plus, Share2 } from 'lucide-react';
...
export default function AlbumClient({ albumId, initialAlbum }: AlbumClientProps) {
  const { data: albumData, isLoading } = useQuery({
    ...
    initialData: initialAlbum ? { success: true, data: initialAlbum } : undefined,
  });
